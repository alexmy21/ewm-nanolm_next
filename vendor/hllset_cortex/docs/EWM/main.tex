...
The materializer (n-gram disambiguation with TF as the final tie-break, and
De Bruijn reconstruction) and
...
Type~2 & Executive   & Materializer + ds-Decoder& n-gram disambiguation, coherence \\
\bottomrule
\end{tabular}
\end{center}
